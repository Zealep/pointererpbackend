...
public interface Constantes {
    ...
    public static final String ID_MODULO = "23";
    ...
    public static final String ID_TABLE_GALERIA_FOTO= "idGaleriaFoto";

    public static final String TABLE_NOTICIA= "rh_in_tz_noticia";
    public static final String ID_TABLE_NOTICIA= "idNoticia";
